...
arg_parser.add_argument('-dc', '--config_path', type=str, default=os.path.join(BASE_DIR, "run", "default_config.yaml"), required=False, help='Base path for configs and data')
arg_parser.add_argument('-n', '--name_of_run', type=str, default="train", required=False, help='Name of the run (for logging purpose)')
